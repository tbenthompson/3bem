...
template <>
struct LaplaceSingle<2>: Kernel<2, double, double, double>
{
    double operator()(double r2, const Vec<double,2>& delta,
...
template <>
struct LaplaceDouble<2>: Kernel<2, double, double, double>
{
    double operator()(double r2, const Vec<double,2>& delta,
                      const Vec<double,2>& nsrc, const Vec<double,2>& nobs) const {
...
template <>
struct LaplaceHypersingular<2>: Kernel<2, double, double, double>
{
    double operator()(double r2, const Vec<double,2>& delta,
                      const Vec<double,2>& nsrc, const Vec<double,2>& nobs) const {
