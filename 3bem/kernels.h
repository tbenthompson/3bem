...
struct ElasticDisplacement<2> {
    ...
    typedef Vec2<Vec2<double>> OutType;
    ...
    OutType operator()(double r2, const Vec2<double>& delta, 
...
struct ElasticDisplacement<3> {
    const double disp_C1;
    const double disp_C2;
    typedef Vec3<Vec3<double>> OutType;
    ...
    OutType operator()(double r2, const Vec3<double>& delta, 
