...
def full_space():
    ...
    mthd = make_adaptive_integrator(1e-13, 6, 6, 5, 8, 4.0, double_kernel)
...
def solve_half_space(slip, fault, surface):
    ...
    hypersingular_mthd = make_adaptive_integrator(
        1e-5, 6, 6, 5, 10, 3.0, LaplaceHypersingular()
    )
...
def half_space_interior(refine):
    ...
    double_mthd = make_adaptive_integrator(1e-5, 6, 6, 5, 10, 3.0, double_kernel)
    hypersingular_mthd = make_adaptive_integrator(1e-5, 6, 6, 5, 10, 3.0, hypersingular_kernel)
