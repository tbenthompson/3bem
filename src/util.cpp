...
template
void hdf_out_surface<2>(const std::string&, const Mesh<2>&, const std::vector<double>&);
template
void hdf_out_surface<3>(const std::string&, const Mesh<3>&, const std::vector<double>&);
